    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-white border-border shadow-xl">
        <CardHeader className="text-center space-y-4">
          ...
          <div>
            <CardTitle className="text-3xl font-bold text-foreground tracking-tight">Grupo Salazar</CardTitle>
            <CardDescription className="text-muted-foreground">Sistema de Control de Estimaciones</CardDescription>
          </div>
        </CardHeader>
